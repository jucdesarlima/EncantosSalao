...
namespace EncantosSalao.Dado.Migrations
{
    ...
    [Migration("20211109005115_EncantosSalao")]
    partial class EncantosSalao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EncantosSalao.Dado.Modelos.Agendamentos", b =>
                {
            ...
            modelBuilder.Entity("EncantosSalao.Dado.Modelos.ApplicationRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EncantosSalao.Dado.Modelos.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EncantosSalao.Dado.Modelos.ServicoSalao", b =>
                {
                    b.Property<string>("IdSalao")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EncantosSalao.Dado.Modelos.Agendamentos", b =>
                {
                    ...
                    b.HasOne("EncantosSalao.Dado.Modelos.ApplicationUser", "Usuario")
                        .WithMany("Agendamentos")
                        .HasForeignKey("IdUsuario")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EncantosSalao.Dado.Modelos.ServicoSalao", "ServicoSalao")
                        .WithMany("Agendamentos")
            ...
            modelBuilder.Entity("EncantosSalao.Dado.Modelos.Salao", b =>
                {
                    ...
                    b.HasOne("EncantosSalao.Dado.Modelos.ApplicationUser", "Proprietario")
                        .WithMany("Saloes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("EncantosSalao.Dado.Modelos.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EncantosSalao.Dado.Modelos.ApplicationUser", null)
                        .WithMany("Reivindicacoes")
