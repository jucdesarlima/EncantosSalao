namespace EncantosSalao.Dado
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        public DbSet<NoticiasBlog> NoticiasBlog { get; set; }
        ...
        public DbSet<ServicoSalao> ServicosSalao { get; set; }
        ...
        private static void SetIsDeletedQueryFilter<T>(ModelBuilder builder)
            where T : class, IEntidadeDeletavel
        {
            builder.Entity<T>().HasQueryFilter(e => !e.EstaExcluido);
        }
        ...
        private void ApplyAuditInfoRules()
        {
            ...
            foreach (var entry in changedEntries)
            {
                ...
                if (entry.State == EntityState.Added && entity.CriadoEm == default)
                {
